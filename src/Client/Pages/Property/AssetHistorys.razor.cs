    ...
    protected override void OnInitialized() =>
        Context = new(
            ...
            fields: new()
            {
                ...
                new(AssetHistory => AssetHistory.AssetName, L["AssetName"], "AssetName"),
                new(AssetHistory => AssetHistory.PreviousQualityStatusName, L["Prev Quality Sta."], "PreviousQualityStatusName"),
                new(AssetHistory => AssetHistory.QualityStatusName, L["Quality Sta."], "QualityStatusName" ),
                new(AssetHistory => AssetHistory.PreviousUsingStatusName, L["Prev Using Sta."], "PreviousUsingStatusName"),
                new(AssetHistory => AssetHistory.UsingStatusName, L["Using Sta."], "UsingStatusName" ),
                new(AssetHistory => AssetHistory.DoccumentLink, L["DoccumentLink"], "DoccumentLink"),
                new(AssetHistory => AssetHistory.Note, L["Note"], "Note"),
                new(AssetHistory => AssetHistory.EmployeeFirstName, L["Owner.F.Name"], "EmployeeFirstName"),
                new(AssetHistory => AssetHistory.EmployeeLastName, L["Owner.L.Name"], "EmployeeLastName"),
